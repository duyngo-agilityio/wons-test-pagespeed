...
const ButtonCustom = extendVariants(ButtonNextUI, {
  variants: {
    color: {
      ...
      secondary:
        'bg-transparent text-blue-500 dark:text-white dark:border-white border-blue-500 dark:text-purple-450 dark:border-purple-600 hover:bg-blue-500 hover:text-white dark:hover:text-blue-800 dark:hover:bg-white',
