        ...
        {(onClose) => (
          <>
            ...
            <ModalFooter className="flex justify-center gap-4">
              ...
              <Button
                className="flex-1 bg-white dark:bg-white text-blue-800/70 dark:text-blue-800/70 border border-gray-300 hover:bg-gray-100 dark:hover:bg-gray-300 px-6 py-2 rounded-10"
